frappe.listview_settings['Asset'] = {
	...
	onload: function(me) {
		...
		//method 3
		me.page.add_action_item(__("Generate QR Code"), function(frm) {
			const assets = me.get_checked_items();
			console.log(assets);
			frappe.call({
				method: "erpnext.assets.doctype.asset.asset.generate_qrcode",
				freeze: true,
				...
				callback: function (r) {
					if (r.message) {
						frappe.set_route("printview", r.message.doctype, r.message.name);
					}
				}
			});
		});
